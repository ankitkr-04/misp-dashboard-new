...
class ControlPlane:
    ...
    def update(self, patch: AdminStateUpdateRequest) -> dict:
        with self._lock:
            ...
            if patch.simulation_profile is not None and patch.simulation_profile in SIMULATION_PROFILES:
